defmodule Finessume do
  @moduledoc """
  Finessume keeps the contexts that define your domain
  and business logic.
  ...
  # Place use statement after module documentation
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        statics: Finessume.static_paths()
    end
  end
